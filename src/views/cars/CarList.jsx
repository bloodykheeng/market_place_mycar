...
export default function CarList({ data, isLoading }) {
  ...
  const listTemplate = (products, layout) => {
    console.log("🚀 ~ listTemplate ~ products:", products);
    if (!products) {
      return;
    }
    return (
    ...
    <div style={{ width: "100%", height: "100%" }}>
      ...
      {selectedProduct && displayProductDialog && (
        <Dialog
          ...
          showHeader={true}
        >
          <CarDetailPage selectedProduct={selectedProduct} />
        </Dialog>
      )}
      ...
      {selectedProduct && displayDialog && (
        <Dialog
          ...
          showHeader={true}
        >
          <CarMedia selectedProduct={selectedProduct} />
        </Dialog>
      )}
    </div>
  );
