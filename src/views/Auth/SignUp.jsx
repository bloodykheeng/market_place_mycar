...
const SignUp = () => {
  ...
  const creactMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(
        ["Vendor", "Seller"].includes(selectedRole)
          ? "Account Information Submitted Successfully Wait Until Admin will verify your account "
  ...
  const onSubmit = (values) => {
    ...
    let finalData = {
      ...values,
      status: selectedRole == "Buyer" ? "active" : "deactive"
    };
    setIsLoading(true);
        ...
        >
          <div className="card">
                      ...
                      {({ input, meta }) => (
                        <div className="m-4 p-field">
                          ...
                          <AutoComplete
                            ...
                            completeMethod={(e) => {
                              const results =
                                getListOfVendors.data?.data?.filter((item) => {
                                  return item.name
                                    .toLowerCase()
                  ...
                  <Field name="agree" type="checkbox">
                    {({ input, meta }) => (
                      <div className="m-4 p-field-checkbox">
                        ...
                        <label
                          htmlFor="agreeterms"
                          onClick={handleTermsDialogToggle}
            ...
            <Dialog
              ...
              style={{ minWidth: "50vw" }}
              maximizable
              onHide={handleTermsDialogToggle}
            >
