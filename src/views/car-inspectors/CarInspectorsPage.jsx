...
import CarInspectorsList from "./CarInspectorsList.jsx";

import { useNavigate } from "react-router-dom";
import { useQuery } from "@tanstack/react-query";
import { getAllCars } from "../../services/cars/car-service.js";
import { getAllCarTypes } from "../../services/cars/car-types-service.js";

import { getAllCarInspectors } from "../../services/auth/user-service.js";
...
function CarInspectorsPage() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["inspectors", params, first, rows],
    queryFn: () =>
      getAllCarInspectors({ ...params, first: first, per_page: rows, page })
  });

  useEffect(() => {
    if (isError) {
      console.log("Error fetching All Car Inspectors:", error);
  ...
  console.log("Car Inspectors data is  : ", data);
          ...
          >
            <React.Fragment>
              <div className="p-inputgroup" style={{ flex: "1 1 300px" }}>
                <InputText
                  placeholder="Search Car Inspector"
                  style={{ width: "100%" }}
                  value={searchQuery}
...
export default CarInspectorsPage;
