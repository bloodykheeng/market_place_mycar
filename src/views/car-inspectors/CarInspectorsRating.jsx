...
import CarInspectorsRatingDialog from "./CarInspectorsRatingDialog";
...
} from "../../services/auth/user-reviews-service";
...
const CarInspectorsRating = ({
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["user-reviews", "by_user_id"],
    queryFn: () => getAllUserReviews({ user_id: productDetailItem?.id })
  });

  console.log("🚀 ~ data:", data);

  useEffect(() => {
    console.log("🚀 ~ CarInspectorsRating ~ error:", error);
    if (isError) {
  ...
  const DeleteSelectedItemMutation = useMutation({
    mutationFn: (variables) => deleteUserReviewById(variables),
    onSuccess: () => {
...
export default CarInspectorsRating;
