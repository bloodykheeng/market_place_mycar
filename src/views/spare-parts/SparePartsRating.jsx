...
import SparePartsRatingDialog from "./SparePartsRatingDialog";
import { confirmDialog } from "primereact/confirmdialog";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import {
  getAllSparePartReviews,
  getSparePartReviewById,
  postSparePartReview,
  updateSparePartReview,
  deleteSparePartReviewById
} from "../../services/spare-parts/spare-reviews-service";
...
const SparePartsRating = ({
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["spare-part-reviews", "by_spare_part_id"],
    queryFn: () =>
      getAllSparePartReviews({ spare_part_id: productDetailItem?.id })
  });
  ...
  const DeleteSelectedItemMutation = useMutation({
    mutationFn: (variables) => deleteSparePartReviewById(variables),
    onSuccess: () => {
      queryClient.invalidateQueries(["spare-part-reviews"]);
...
export default SparePartsRating;
